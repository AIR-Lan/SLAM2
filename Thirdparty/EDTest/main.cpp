...
/// Two functions to read/save PGM files
    ...
    int main() {
        ...
        ORB_SLAM3::EdgeMap *map = DetectEdgesByED(srcImg, width, height, ORB_SLAM3::SOBEL_OPERATOR, 36, 8, 1.0);
        ...
        map = ORB_SLAM3::DetectEdgesByEDPF(srcImg, width, height, 1.0);
        ...
        map = ORB_SLAM3::DetectEdgesByCannySR(srcImg, width, height, 40, 80, 3, 1.0);
        ...
        map = ORB_SLAM3::DetectEdgesByCannySRPF(srcImg, width, height, 3, 1.0);
