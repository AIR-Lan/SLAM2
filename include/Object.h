...
namespace ORB_SLAM3
{
    ...
    public:
        ...
        // line.
        Eigen::MatrixXd mObjLinesEigen;//merge之后的线
        ...
        void ObjectDataAssociation(Atlas* mpAtlas, Frame &mCurrentFrame, cv::Mat &image, string &flag);    // data association.
    ...
    public:
        ...
        EIGEN_MAKE_ALIGNED_OPERATOR_NEW//MYNOTE
        ...
        cv::Mat mSumPointsPos;//物体所有点的 相当于oa的pts
        cv::Mat mCenter3D;//这些点的中心坐标相当与oa 的center
        ...
        void WhetherMergeTwoMapObjs(Atlas *mpAtlas);
