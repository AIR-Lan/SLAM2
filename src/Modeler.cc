...
// Modeler Class
    Modeler::Modeler(ORB_SLAM3::Atlas *pAtlas) {
        mnLastNumLines = 2;
    ...
    void Modeler::AddKeyFrameEntry(ORB_SLAM3::KeyFrame *pKF) {
        if (mbFirstKeyFrame) {
    ...
    void Modeler::AddLineSegmentKeyFrameEntry(ORB_SLAM3::KeyFrame *pKF) {
        unique_lock<mutex> lock(mMutexTranscript);
